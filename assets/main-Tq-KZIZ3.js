import{o as s,h as c,g as l}from"./api-C3oZcLFk.js";import{g as d}from"./favoriteHero-Cj1f5rFi.js";const i="Oops, no data..",m=document.querySelector("#favoritedList"),a="http://localhost:8080/superheroes/",u=()=>{s(),c(),y(),p()},h=(e,o)=>Math.floor(Math.random()*(o-e+1))+e,v=()=>h(1,3344),g=async()=>{try{const e=await fetch(a+"team");if(e.ok){const o=await e.json();return console.log("comic team",o),o}else console.error("Error in getTeamData. Status: "+e.statusText)}catch(e){console.error("Request failed in getTeamData. Message: "+e.message)}},f=e=>`<div id="hero-banner">
    ...
    `,y=async()=>{const e=await M();e.error=="Object Not Found"?console.log("refresh for a valid movie"):m.insertAdjacentHTML("beforebegin",b(e.results))};u();const I=async e=>{if(console.log("In hero favorites to objects."),e!==null)return Promise.all(e.map(o=>l(o)))},H=async()=>{console.log("In hero card maker.");const e=await I(d());if(e){const o=document.querySelector("#favoritedList");o.insertAdjacentHTML("beforebegin",'<h2 id="favoriteListTitle">Favorite Heroes</h2>'),e.forEach(t=>{o.insertAdjacentHTML("beforeend",`
                <div class="heroCard">
